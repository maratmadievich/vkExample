...
class CustomSquareIndicator: UIActivityIndicatorView {
    ...
    override func startAnimating() {
        self.backgroundColor = UIColor.squareIndicator.background
        
        myLayer.path = nil
        myLayer.lineWidth = 4
        
        myLayer.strokeColor = UIColor.squareIndicator.strokeColor.cgColor
        myLayer.fillColor = UIColor.squareIndicator.fillColor.cgColor
